    ...
    public class AlgorithmDAL
    {
        public bool updateMPVBase(int id, MPVBaseMessageOutBadClass newClass, string type, string year, string month, string day, string hour)
        {
            try
            {
                ...
                isok = MysqlHelper.ModifySingleSql("updateMPVBase", CommandType.StoredProcedure, paramses, ref errmsg);
        ...
        private bool deleteTime(int pid)
        {
            try
            {
                try
                {
                    ...
                    isok = MysqlHelper.ModifySingleSql("deleteTimeValue", CommandType.StoredProcedure, paramses, ref errmsg);
                    return isok;
                }
                catch (Exception ex)
                {
