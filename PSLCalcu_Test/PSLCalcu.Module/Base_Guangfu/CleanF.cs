...
{
    public class CleanF : BaseModule, IModule, IModuleExPara
    {
        ...
        //y=k(x1+x2)+b;
        private string _moduleName = "CleanF";
        ...
        private string _moduleDesc = "清洗提示系数";
        ...
        private string _algorithms = "CleanF";
        ...
        private string _outputDescs = "CleanF";
        ...
        private string _outputDescsCN = "清洗提示系数";
        ...
        #endregion
        #region 输入参数
        private string _moduleParaExample = "1";    // 注意：如果计算模块需要参数，则该属性必须有值，不能为空。检查程序依据此属性是否为空来决定是否对配置项进行正则检查
        ...
        private string _moduleParaDesc = "k1";    // 注意：如果计算模块需要参数，则该属性必须有值，不能为空。检查程序依据此属性是否为空来决定是否对配置项进行正则检查
        ...
        private Regex _moduleParaRegex = new Regex(@"^([+-]?\d+(\.\d+)?){1}$");
