...
{
    public class BWGPwrEff : BaseModule, IModule, IModuleExPara
    {
        ...
        //y=k(x1+x2)+b;
        private string _moduleName = "BWGPwrEff";
        ...
        private string _moduleDesc = "并网柜发电效率";
        ...
        private string _inputDescsCN = "并网柜发电量;辐照量";
        ...
        private string _algorithms = "BWGPwrEff";
        ...
        private string _outputDescs = "BWGPwrEff";
        ...
        private string _outputDescsCN = "并网柜发电效率";
        ...
        #endregion
        #region 输入参数
        private string _moduleParaExample = "20;30;50";    // 注意：如果计算模块需要参数，则该属性必须有值，不能为空。检查程序依据此属性是否为空来决定是否对配置项进行正则检查
        ...
        private string _moduleParaDesc = "k1;k2;k3";    // 注意：如果计算模块需要参数，则该属性必须有值，不能为空。检查程序依据此属性是否为空来决定是否对配置项进行正则检查
        ...
        public static Results Calcu(List<PValue>[] inputs, CalcuInfo calcuinfo)
        {
            ...
            try
            {
                ...
                PValue BWGPwrEff = new PValue(0, calcuinfo.fstarttime, calcuinfo.fendtime, 0);
                ...
                result = a / k1 * b / k3 * k2 * 100;
                BWGPwrEff.Value = result;
                results[0] = new List<PValue>();
                results[0].Add(BWGPwrEff);
