...
namespace PSLCalcu.Module
{
    ...
    /// </author> 
    /// </summary>
    public class M2AnalogDiv : BaseModule, IModule, IModuleExPara
    {
        ...
        //y=k(x1+x2)+b;
        private string _moduleName = "M2AnalogDiv";//"M2AnalogDiv"
        ...
        private string _moduleDesc = "两个模拟量的除法，得到一个新的模拟量";
        ...
        private string _inputDescsCN = "被除数;除数";
        ...
        private string _algorithms = "2AnalogDiv";
        ...
        private string _outputDescs = "2AnalogDiv";
        ...
        private string _outputDescsCN = "模拟量相除结果";
        ...
        public static Results Calcu(List<PValue>[] inputs, CalcuInfo calcuinfo)
        {
            ...
            try
            {
                ...
                result.Add(new PValue(currentMul, spanconcat[0].Datetime, new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Local), 0));
                for (i = 0; i < spanconcat.Count; i++)
                {
                    ...
                    {//如果当前时间不等于上一次时间，说明上一个时刻的所有状态变化处理完毕，flagSeries以代表上一个时刻最后状态
                        ...
                        if (valueSeries[0] == 0) {
                            currentMul = -1.79769313486232E+307;
                        }
                        else if (valueSeries[1] == 0)
                        {
                            currentMul=1.79769313486232E+307;
                        }
                        else {
                            currentMul = k * (valueSeries[0] / valueSeries[1]) + b;
                        }
                       
                        //填写上上时刻点的结束时间
                        result[result.Count - 1].Value = currentMul;
