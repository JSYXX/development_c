...
namespace PSLCalcu.Module
{
    ...
    /// </author> 
    /// </summary>
    public class MFindMaxInfo:BaseModule, IModule
    {
        ...
        private string _moduleName = "FindMaxInfo";
        ...
        private string _moduleDesc = "求各输入变量中的最大值、时间、及其对应的变量序号";
        ...
        private string _inputDescsCN = "被统计量，至少要两个，最多不限";
        ...
        private string _algorithms = "FindMaxInfo";
        ...
        private string _outputDescs =   "FMaxValue;FMaxIndex";
        ...
        private string _outputDescsCN = "最大值;最大值对应的标签序号(从0开始)";
        ...
        #region 计算模块算法
        /// <summary>
        /// 计算模块算法实现:求多个输入中，所有值得最大值,对应的时间，对应变量的序号
        /// </summary>
        ...
        /// <returns>最大值,对应的时间，对应变量的序号</returns>
        ...
        public static Results Calcu(List<PValue>[] inputs, CalcuInfo calcuinfo)
        {
            ...
            try 
            {
                ...
                //2、查找最大值
                var max = series.OrderByDescending(n => n).Take(1);
                var maxlist = max.ToList<double>();

                //3、根据最大值确定时间、序号
                double maxValue = maxlist[0];
                double maxIndex = valueIndex[maxValue];
                DateTime maxDate = valueDate[maxValue]; 
                ...
                results[0].Add(new PValue(maxValue, maxDate, calcuinfo.fendtime, 0));
                results[1].Add(new PValue(maxIndex, calcuinfo.fstarttime, calcuinfo.fendtime, 0));
