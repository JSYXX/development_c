        ...
        public static Results Calcu(List<PValue>[] inputs, CalcuInfo calcuinfo)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    mDevMessageInClass.DevHLHHLLR = MathHelper.returnProportionUpdateStr(DevHLHHLLT, effectiveCount, mDevMessageInClass.DevHLHHLLR);
                    mDevMessageInClass.DevHHR = MathHelper.returnProportionUpdateStr(DevHHT, effectiveCount, mDevMessageInClass.DevHHR);
                    mDevMessageInClass.DevHR = MathHelper.returnProportionUpdateStr(DevHT, effectiveCount, mDevMessageInClass.DevHR);
                    mDevMessageInClass.DevRPR = MathHelper.returnProportionUpdateStr(DevRPT, effectiveCount, mDevMessageInClass.DevRPR);
                    mDevMessageInClass.Dev0PR = MathHelper.returnProportionUpdateStr(Dev0PT, effectiveCount, mDevMessageInClass.Dev0PR);
                    mDevMessageInClass.Dev0NR = MathHelper.returnProportionUpdateStr(Dev0NT, effectiveCount, mDevMessageInClass.Dev0NR);
                    mDevMessageInClass.DevRNR = MathHelper.returnProportionUpdateStr(DevRNT, effectiveCount, mDevMessageInClass.DevRNR);
                    mDevMessageInClass.DevLR = MathHelper.returnProportionUpdateStr(DevLT, effectiveCount, mDevMessageInClass.DevLR);
                    mDevMessageInClass.DevLLR = MathHelper.returnProportionUpdateStr(DevLLT, effectiveCount, mDevMessageInClass.DevLLR);
                    mDevMessageInClass.Dev0HTR = MathHelper.returnProportionUpdateStr(Dev0HT, effectiveCount, mDevMessageInClass.Dev0HTR);
                    mDevMessageInClass.Dev0LR = MathHelper.returnProportionUpdateStr(Dev0L, effectiveCount, mDevMessageInClass.Dev0LR);
                    mDevMessageInClass.DevHHLLTR = MathHelper.returnProportionUpdateStr(DevHHLLT, effectiveCount, mDevMessageInClass.DevHHLLTR);
                    mDevMessageInClass.DevRPRMHLTR = MathHelper.returnProportionUpdateStr(DevRPRMHLT, effectiveCount, mDevMessageInClass.DevRPRMHLTR);
                    mDevMessageInClass.Dev0RPRMTR = MathHelper.returnProportionUpdateStr(Dev0RPRMT, effectiveCount, mDevMessageInClass.Dev0RPRMTR);
                    mDevMessageInClass.DevHLTR = MathHelper.returnProportionUpdateStr(DevHLT, effectiveCount, mDevMessageInClass.DevHLTR);
                    mDevMessageInClass.UpdateTime = input[0].Timestamp.ToString("yyyy-MM-dd HH:mm");
                ...
                results[1].Add(new PValue(Convert.ToDateTime(mDevMessageInClass.DevHHR).Ticks, Convert.ToDateTime(dutyTime), Convert.ToDateTime(dutyEndTime), 0));
                ...
                results[4].Add(new PValue(Convert.ToDateTime(mDevMessageInClass.Dev0PR).Ticks, Convert.ToDateTime(dutyTime), Convert.ToDateTime(dutyEndTime), 0));
                ...
                results[10].Add(new PValue(Convert.ToDateTime(mDevMessageInClass.Dev0LR).Ticks, Convert.ToDateTime(dutyTime), Convert.ToDateTime(dutyEndTime), 0));
                ...
                results[13].Add(new PValue(Convert.ToDateTime(mDevMessageInClass.Dev0RPRMTR).Ticks, Convert.ToDateTime(dutyTime), Convert.ToDateTime(dutyEndTime), 0));
