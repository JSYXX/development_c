...
namespace PSLCalcu.Module
{
    ...
    /// </author> 
    /// </summary>
    public class MFDistribute52 : BaseModule, IModule, IModuleExPara
    {
        ...
        private string _moduleName = "MFDistribute52";
        ...
        private string _moduleDesc = "快速分布算法52段";
        ...
        private string _algorithms = "MFDistribute52";
        ...
        private string _outputDescs = "D52S0;D52S1;D52S2;D52S3;D52S4;D52S5;D52S6;D52S7;" +
                                      "D52S8;D52S9;D52S10;D52S11;D52S12;D52S13;D52S14;" +
                                      "D52S15;D52S16;D52S17;D52S18;D52S19;D52S20;D52S21;" +
                                      "D52S22;D52S23;D52S24;D52S25;D52S26;D52S27;D52S28;" +
                                      "D52S29;D52S30;D52S31;D52S32;D52S33;D52S34;D52S35;" +
                                      "D52S36;D52S37;D52S38;D52S39;D52S40;D52S41;D52S42;" +
                                      "D52S43;D52S44;D52S45;D52S46;D52S47;D52S48;D52S49;" +
                                      "D52S50;D52S51"
                                      ;
        ...
        private string _outputDescsCN = "52段分布第0段;52段分布第1段;52段分布第2段;52段分布第3段;52段分布第4段;" +
                                        "52段分布第5段;52段分布第6段;52段分布第7段;52段分布第8段;" +
                                        "52段分布第9段;52段分布第10段;52段分布第11段;52段分布第12段;" +
                                        "52段分布第13段;52段分布第14段;52段分布第15段;52段分布第16段;" +
                                        "52段分布第17段;52段分布第18段;52段分布第19段;52段分布第20段;" +
                                        "52段分布第21段;52段分布第22段;52段分布第23段;52段分布第24段;" +
                                        "52段分布第25段;52段分布第26段;52段分布第27段;52段分布第28段;" +
                                        "52段分布第29段;52段分布第30段;52段分布第31段;52段分布第32段;" +
                                        "52段分布第33段;52段分布第34段;52段分布第35段;52段分布第36段;" +
                                        "52段分布第37段;52段分布第38段;52段分布第39段;52段分布第40段;" +
                                        "52段分布第41段;52段分布第42段;52段分布第43段;52段分布第44段;" +
                                        "52段分布第45段;52段分布第46段;52段分布第47段;52段分布第48段;" +
                                        "52段分布第49段;52段分布第50段;52段分布第51段;";
        ...
        public static Results Calcu(List<PValue>[] inputs, CalcuInfo calcuinfo)
        {
            ...
            try
            {
                ...
                //处理截止时刻数据，本算法视曲线为阶梯型。直接去掉最后截止时刻值
                if (input.Count > 1) input.RemoveAt(input.Count - 1);

                //1、准备边界标识数组
                double[] LimitRange = new double[52 - 1];  //界限数组，用于查找当前value值处于的值域段。
                ...
                if (rangeMin == rangeMax) return new Results(null, _errorFlag, _errorInfo, _warningFlag, _warningInfo, _fatalFlag, _fatalInfo);

                //
                double rangeSection = (rangeMax - rangeMin) / (52 - 2);
                for (i = 0; i < (52 - 2); i++)
                {
                    LimitRange[i] = rangeMin + rangeSection * i;
                }
                LimitRange[52 - 2] = rangeMax;

                //2、准备存储变量
                double[] section = new double[52];    //一共22个统计段，21个分隔点

                //3、对数据进行遍历
                double[] SortArray = new double[52];    //一共22个统计段，21个分隔点,加当前排序点，一共22个排序点
                int currentSection;
                for (int iPoint = 0; iPoint < input.Count; iPoint++)
                {
                    LimitRange.CopyTo(SortArray, 0);
                    SortArray[52 - 1] = input[iPoint].Value;
