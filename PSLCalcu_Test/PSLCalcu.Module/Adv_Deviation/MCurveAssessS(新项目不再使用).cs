...
using Config;   //使用log
using System.Windows.Forms; //某些情况下调试需要
...
namespace PSLCalcu.Module
{
    ...
    /// </author> 
    /// </summary>
    public class MCurveAssessS : BaseModule, IModule, IModuleExPara
    {
        #region 计算模块信息：一维偏差及得分计算(单值计算);

        private string _moduleName = "MCurveAssessS";
        ...
        private string _outputDescs = "SOPX;SOPXE;SOPXERate;SOPXW";
