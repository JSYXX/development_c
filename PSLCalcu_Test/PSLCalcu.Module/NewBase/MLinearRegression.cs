...
{
    public class MLinearRegression : BaseModule, IModule, IModuleExPara
    {
        #region 计算模块信息：

        private string _moduleName = "MLinearRegression";
        ...
        private string _algorithms = "MLinearRegression";
        ...
        private string _moduleParaExample = "1;2;1;2;1;2;1;1;1;1;1;1";   // 注意：如果计算模块需要参数，则该属性必须有值，不能为空。检查程序依据此属性是否为空来决定是否对配置项进行正则检查
        ...
        private string _moduleParaDesc = "K;kR;M;SE;Result;Status;e;e;e;e;e;e";// 注意：如果计算模块需要参数，则该属性必须有值，不能为空。检查程序依据此属性是否为空来决定是否对配置项进行正则检查
