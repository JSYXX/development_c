...
namespace PSLCalcu.Module
{
    ...
    /// </author> 
    /// </summary>
    public class MArithmeticSumAvg : BaseModule, IModule
    {
        ...
        private string _moduleName = "ArithmeticdSumAvg";
        ...
        private string _moduleDesc = "算术累加和平均值";
        ...
        private string _algorithms = "ASum;AAvg";
        ...
        private string _outputDescs = "ASum;AAvg";
        ...
        private string _outputDescsCN = "算术累加和;算术平均值";
        ...
        /// <returns>计算结果分别为算术累加值和算术平均值</returns>
        /// 
        ...
        public static Results Calcu(List<PValue>[] inputs, CalcuInfo calcuinfo)
        {
            ...
            {             
                ...
                results[0].Add(new PValue(ASum, calcuinfo.fstarttime, calcuinfo.fendtime, 0));
                results[1].Add(new PValue(AAvg, calcuinfo.fstarttime, calcuinfo.fendtime, 0));
