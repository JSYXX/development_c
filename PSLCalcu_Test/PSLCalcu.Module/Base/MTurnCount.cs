...
namespace PSLCalcu.Module
{
    ...
    /// </author> 
    /// </summary>
    public class MTurnCount : BaseModule, IModule
    {
        #region 计算模块信息：模块名称翻转次数TurnCount、输出项个数1、输出项名称TurnCount、输出项写入的数据表名称plsdata

        private string _moduleName = "TurnCount";
        ...
        private string _moduleDesc = "翻转次数";
        ...
        private string _algorithms = "TurnCount";
        ...
        private string _outputDescs = "TurnCount";
        ...
        private string _outputDescsCN = "翻转次数";
        ...
        public static Results Calcu(List<PValue>[] inputs, CalcuInfo calcuinfo)
        {
            ...
            {               
                ...
                #region 初始化
                PValue TurnCount = new PValue(0, calcuinfo.fstarttime, calcuinfo.fendtime, 0);
                ...
                {
                    #region 翻转次数
                    //翻转次数，i要小于len-2,即确定时间段内，过程变量变化中翻转的次数
                    if (i < len - 2)
                    {
                        if ((input[i + 1].Value - input[i].Value) * (input[i + 2].Value - input[i + 1].Value) < 0) //判断是否翻转
