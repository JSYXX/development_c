...
namespace PSLCalcu.Module
{
    ...
    /// </author> 
    /// </summary>
    public class MWeightSumAvg : BaseModule, IModule, IModuleExPara
    {
        ...
        private string _moduleName = "MWeightSumAvg";
        ...
        private string _moduleDesc = "加权累加和平均值";
        ...
        private string _moduleParaExample = "M";  // 注意：如果计算模块需要参数，则该属性必须有值，不能为空。检查程序依据此属性是否为空来决定是否对配置项进行正则检查
        ...
        private Regex _moduleParaRegex = new Regex(@"^([SMHD]){1}$");
        ...
        private string _outputDescs = "WSum;WAvg";
        ...
        private string _outputDescsCN = "加权累加和;加权平均值";
