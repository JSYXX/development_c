...
namespace DBInterface.RDBInterface
{
    ...
    /// 修改纪录
    /// 
    ///		2008.08.26 版本：2.0 Arrow 将主键进行精简整理。
    ///		2008.08.25 版本：1.3 Arrow 将标准数据库接口方法进行分离、分离为标准接口方法与扩展接口方法部分。
    ///		2008.06.03 版本：1.2 Arrow 增加 DbParameter[] dbParameters 方法。
    ///		2008.05.07 版本：1.1 Arrow 增加GetWhereString定义。
    ///		2008.03.20 版本：1.0 Arrow 创建标准接口。
    /// 
    /// 版本：2.0
    /// 
    /// <author>
